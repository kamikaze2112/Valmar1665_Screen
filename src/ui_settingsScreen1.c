...
ui_btnCalibrate3 = lv_button_create(ui_settingsScreen1);
...
ui_arcMotorPWM = lv_arc_create(ui_settingsScreen1);
...
ui_arcTestSpeed = lv_arc_create(ui_settingsScreen1);
...
ui_panelReset = lv_obj_create(ui_settingsScreen1);
